...
long BasicStepperDriver::nextAction(void){
    if (steps_remaining > 0){
        delayMicrosTM4C(next_action_interval);
        /*
...
/**
 * 1 NOP is exactly one clock cycle on ARM Cortex-M4.
 * Our TM4C platforms run at 80 MHz.
 * 1 NOP = 12.5ns
 * 1us = 1000ns = 80 * 12.5ns = 80 NOP's
 * 
